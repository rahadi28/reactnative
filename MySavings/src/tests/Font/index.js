...
export default () => {
  return (
    <ScrollView style={styles.scroller}>
      ...
      <Text style={{fontFamily: 'small-caps'}}> small-caps </Text>
      <Text style={{fontFamily: 'oldstyle-nums'}}> oldstyle-nums </Text>
      <Text style={{fontFamily: 'lining-nums'}}> lining-nums </Text>
      <Text style={{fontFamily: 'tabular-nums'}}> tabular-nums </Text>
      <Text style={{fontFamily: 'proportional-nums'}}> proportional-nums </Text>
      <Text style={{fontFamily: 'josefin-sans-regular'}}> josefin-sans-regular </Text>
      <Text style={{fontFamily: 'raleway-regular'}}> raleway-regular </Text>
